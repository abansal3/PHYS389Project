...
#define input constants as sympy variables
        self.name = name
...
#solve ODE
        self.ans = odeint(dZdt, y0=[0.5, 0, np.pi/3, 0], t=self.t)
...
#convert this to x and y coordinates for particles
        ...
        def animate(i):
            ln1.set_data([self.x1[i], self.x2[i]], [0, self.y2[i]])
        ...
        self.ani.save('PendulumSpring.gif', writer='pillow', fps=50)
